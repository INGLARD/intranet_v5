...
$update_magasin = editMag($dbconn2, $code_mag, $id_enseigne_mag, $adresse_ip_mag, $nom_mag, $nom_global_mag, $status_mag, $type_mag, $adresse_1_mag, $adresse_2_mag, $code_postale_mag, $ville_mag, $telephone_mag, $telephone_portable_mag, $fax_mag, $email_mag, $latitude_mag, $longitude_mag);
